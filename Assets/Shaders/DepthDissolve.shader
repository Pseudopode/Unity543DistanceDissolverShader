	...
	SubShader
	{
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				//for the following lines : https://thelazydev.net/blog/post/shading-toolbox-3-unity-depth-buffer-and-depth-blur
				//depth = depth * _ProjectionParams.z * 0.01;
